...
namespace BatCatTracks
{
	...
	public class Constants
	{
		...
		public static readonly int IronLegion = 283;
		public static readonly int GirlsMons = 248;
		public static readonly int Elementals = 277;
		...
		public static readonly int UberFest = 286;
		public static readonly int EpicFest = 287;

		// limited:
		public static readonly int Baseball = 265;
		public static readonly int Eva = 282;
	}
}
